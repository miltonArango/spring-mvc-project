...
/**
 * Created by Marango on 28/02/2017.
 *
 */
public class ProductControllerTest {
    ...
    public void testList() throws Exception{
        ...
        when(productService.listAll()).thenReturn((List) products); //Need to pass generic objects
    ...
    public void testSaveOrUpdate() throws Exception{
        ...
        //Assert the properties of the bound object with the returned Product
